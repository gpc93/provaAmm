...
<html>
    ...
    <body>
        <div id="page">
            ...
            <!--CONTENT-->
            <div id="content"> 
                <c:if test="${empty prodottoDaModificare}">
                    <div id="objTab">
                    ...
                    <c:forEach var="prodotto" items="${listaProdotti}" >
                               <tr>
                                ...
                                <td><a href="formModifica?idProdotto=${prodotto.idProdotto}"><img title="add" alt="aggiungi al carrello" src="./img/tabIcon.png" width="20" height="20"></a></td>
                            </tr> 
                ...
                <c:if test="${not empty prodottoDaModificare}">
